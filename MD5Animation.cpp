...
bool MD5Animation::LoadAnimaion(const string& filename)
{
...
void MD5Animation::InterpolateSkeletons( FrameSkeleton& finalSkeleton, const FrameSkeleton& skeleton0, const FrameSkeleton& skeleton1, float fInterpolate )
{
    for ( int i = 0; i < m_iNumJoints; ++i )
    {
        ...
        finalJoint.m_Pos =Math::lerp( joint0.m_Pos, joint1.m_Pos, fInterpolate );
        finalJoint.m_Orient = Math::slerp( joint0.m_Orient, joint1.m_Orient, fInterpolate );
    }
}